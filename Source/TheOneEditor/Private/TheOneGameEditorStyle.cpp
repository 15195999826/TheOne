...
TSharedPtr< FSlateStyleSet > FTheOneGameEditorStyle::StyleInstance = nullptr;

void FTheOneGameEditorStyle::Initialize()
{
...
void FTheOneGameEditorStyle::Shutdown()
{
...
FName FTheOneGameEditorStyle::GetStyleSetName()
{
...
TSharedRef< FSlateStyleSet > FTheOneGameEditorStyle::Create()
{
	TSharedRef<FSlateStyleSet> StyleRef = MakeShareable(new FSlateStyleSet(FTheOneGameEditorStyle::GetStyleSetName()));
...
const ISlateStyle& FTheOneGameEditorStyle::Get()
{
